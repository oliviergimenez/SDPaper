...
\hypersetup{
  ...
  pdfauthor={Olivier Gimenez1*; Abby Keller2*; Cassie Speakman3*},
  colorlinks=true,
  linkcolor={RoyalBlue},
  filecolor={Maroon},
  citecolor={Blue},
...
\author{Olivier Gimenez\textsuperscript{1}* \and Abby Keller\textsuperscript{2}* \and Cassie Speakman\textsuperscript{3}*}
\date{2025-10-09}
