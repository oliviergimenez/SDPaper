...
Target journal: soit NeoBiota \url{https://www.reabic.net/journals/mbi/Submission.aspx} (1200 euros, plusieurs formats d'article pertinents) ou encore Biological invasions au format INVASION NOTES, ou encore Peer Community journal.
...
\emph{Keywords}: Invasive species, Structured decision making, Adaptive management, Stochastic dynamic programming
...
Effective management of invasive species requires the estimation of population abundance for guiding control efforts and evaluating the success of eradication or regulation programs (\citeproc{ref-Williams2002}{Williams et al. 2002}, \citeproc{ref-Thompson2021}{Thompson et al. 2021}).
...
\subsection{Why and what}\label{why-and-what}

\subsection{Stochastic dynamic programming}\label{stochastic-dynamic-programming}
...
\subsection{Single population}\label{single-population}

Reprendre l'exemple loup de Lulu dans l'article SDP

\subsection{Two interacting species}\label{two-interacting-species}
...
llustrer POMDP (\url{https://chatgpt.com/share/68814183-9078-8011-9697-c3ee73b27762})

\subsection{Adaptive management}\label{adaptive-management}

Sur une espèce (voir \url{https://chatgpt.com/share/6873c9fd-4df4-8011-97cb-2b6147d505fe} ; voir aussi le bouquin de Conroy sur SDM, il y a une figure qui l'explique bien).
