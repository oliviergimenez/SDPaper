...
Invasive species are a major driver of ecological disruption, economic losses, and risks to human health and food security, and their management often requires repeated decisions under uncertainty, limited budgets, and imperfect knowledge of ecological dynamics, which are frequently characterized by strong population fluctuations, rapid spread, and broad spatial distributions. In practice, managers must decide not only whether to intervene, but also when, where, and how strongly, while balancing short-term operational costs against long-term socio-ecological benefits (Hauser and Possingham 2008). This makes invasive species management a complex decision problem, in which predicting invasion dynamics, or risk forecasting alone are insufficient unless it is explicitly linked to management objectives, feasible actions, and measurable consequences.

Although invasive species management does not always involve strongly opposed objectives, as in some human--wildlife conflicts, the utility function can still be highly complex. Management decisions must weigh expected effectiveness against economic costs, operational effort, feasibility, timing, and the potential unintended impacts of control actions, including non-target effects (Poulin 2015). These decisions are further complicated by the fact that invasive species and their control may be perceived differently by different stakeholders, so that social acceptability becomes an important component of management outcomes (Estevez et al.~2014). More broadly, controversies surrounding invasive species management may reflect differences in environmental values, risk perceptions, rather than disagreement over ecological evidence alone (Simberloff 2012). In this context, several authors have argued that assessing ecological effectiveness of invasive species control measures is not sufficient, and that management strategies should also be evaluated in terms of their social impacts (Crowley et al.~2017). Recent studies further confirm that commonly proposed management interventions, particularly those involving lethal control, often face substantial public resistance or stakeholder conflict, making social feasibility a central dimension of management success (Simmons et al.~2025; Busby et al.~2025).

That's why SDP is an approriate method for invasive species\ldots{} In invasive species management, SDP has been applied to problems such as balancing prevention and control for zebra mussels, optimizing search effort for red imported fire ants in Australia, selecting integrated control strategies for invasive weeds such as leafy spurge or blackberry, and determining whether prevention, eradication, control, or adaptation is optimal under different stages of aquatic invasions.

In practice, SDP treats invasive species management as a sequential decision problem in which actions are optimized over time rather than evaluated in isolation. The sequence of decisions are optimal actions over time that depend on the current state of the system, such as infestation size, invaded area, local density. At each time step, managers can choose among several actions including preventing establishment, conducting routine surveillance, intensifying search in high-risk areas, containing spread from invaded sites, reducing local abundance through control, attempting eradication of already established populations, or postponing intervention when action is not expected to be worthwhile (Moore et al.~2011). The consequences of each action are then evaluated under stochastic population dynamics, imperfect detection (in the case of POMDP, e.g Haight \& Polasky (2010)) and partial controlability, while accounting for the expected future effects of each action on progressing towards the ecological, economic, or social objectives that management seeks to optimize (Williams et al.~2001). More specifically, SDP has been used to determine how much to invest in prevention versus post-invasion control for the invasive zebra mussels within nuclear power-plant water systems (Leung et al.~2002), to optimize control strategies (mechanical, chemical, biological) for the invasive weed leafy spurge by combining information on density and spatial spread (Hyder et al.~2008), to identify state-dependent management policies for an invasive gypsy moth (Lymantria dispar) considering the metapopulation with different patch sizes and spread dynamics (Bogich and Shea 2008), to optimize search effort for the red imported fire ant in Queensland by balancing broad surveillance against targeted search and learning (Baxter et al.~2011), and to compare prevention, control, eradication, and adaptation strategies for aquatic invasive species under different stages of invasion (Hyytiäinen et al.~2013).
...
\pandocbounded{\includegraphics[keepaspectratio]{bellman1.png}}

\pandocbounded{\includegraphics[keepaspectratio]{bellman2.png}}
