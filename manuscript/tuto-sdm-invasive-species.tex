...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{output/figures/fig-removal-fraction-1.pdf}}
\caption{\label{fig:fig-removal-fraction}Removal fraction q(u) as a function of control effort u.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{output/figures/fig-cost-components-1.pdf}}
\caption{\label{fig:fig-cost-components}Immediate cost components as functions of abundance. Damage increases nonlinearly with population size, leading to rapidly rising total costs (damage + penalty). The dotted line marks the tolerable threshold (N\_tol = 400) above which an additional penalty is applied in the decision model, although it is not shown here for clarity. Control cost is illustrated for an example effort level (u = 0.6).}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{output/figures/fig-policy-and-trajectory-1.pdf}}
\caption{\label{fig:fig-policy-and-trajectory}Optimal policy u*(N) (top) and an example trajectory under the optimal policy (bottom, facetted into abundance and effort), starting from N0 = 800.}
\end{figure}
...
\pandocbounded{\includegraphics[keepaspectratio]{output/figures/show-prob-curves-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{output/figures/fig-tradeoff-1.pdf}}
\caption{\label{fig:fig-tradeoff}Representation of the cost components on the log scale. Damage costs increase linearly with total abundance across sites, whereas control costs are fixed action-specific intercepts (none/moderate/strong). Stronger control increases immediate spending but can reduce future abundance and damages.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{output/figures/fig-cum-costs-1.pdf}}
\caption{\label{fig:fig-cum-costs}Cumulative costs over time under constant strategies (none, moderate, strong) versus the SDP-optimal policy. Costs combine damages proportional to total abundance and an action-specific control cost.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{output/figures/fig-site-dynamics-1.pdf}}
\caption{\label{fig:fig-site-dynamics}Site-level abundance dynamics under constant strategies and the SDP-optimal policy. Each panel corresponds to a site; trajectories highlight how spatial heterogeneity and network-driven recolonization can create uneven benefits of control across locations.}
\end{figure}
