...
knitr::include_graphics("bellman-fig-v2.png")
```
...
## 4.3 Acounting for observation error with POMDP
...
## 4.4 Reducing model uncertainty with adaptive management
