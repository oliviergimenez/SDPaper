...
We will consider a model set with five possible values of \(m\). This model bounds, but does not contain, the true model we will use to simulate dynamics in the passive adaptive management approach (Figure \ref{fig:adaptive-plot}A). These different values of \(m\) result in different optimal policies when system dynamics are known perfectly (Figure \ref{fig:adaptive-plot}B).
