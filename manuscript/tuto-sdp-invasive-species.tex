...
\urlstyle{same}
\hypersetup{
  pdftitle={Using stochastic dynamic programming for making decisions about invasive species},
...
\title{Using stochastic dynamic programming for making decisions about invasive species}
