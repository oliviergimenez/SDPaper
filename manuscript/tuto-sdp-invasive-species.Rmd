...
*Keywords*: Adaptive management, Decision theory, Invasive species, Stochastic dynamic programming, Structured decision making, Value of Information, Uncertainty
...
Together, the transition matrices and reward function provide all the ingredients needed to formulate the SDP problem. The key idea is that the value of a management decision depends not only on its immediate consequences, but also on how it influences future opportunities. This principle is formalized by the Bellman equation [@bellmanDynamicProgramming2003],
